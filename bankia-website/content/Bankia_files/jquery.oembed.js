...
(function($) {
    $.fn.oembed = function(url, options, embedAction) {
        ...
        return this.each(function() {
            ...
            if (resourceURL !== null) {
				  //recuperamos el ancho x alto forzado del embebido.
				  var anchoForzado = null;
				  var altoForzado = null;
				  var aux = container.attr('class').split(" ");
				  if(aux[1] != null) {
				  	var aux = aux[1].split("_");
				  	if(aux[0] == "d" && !isNaN(aux[1]) && !isNaN(aux[2])) {
				  		anchoForzado = parseInt(aux[1]);
				  		altoForzado = parseInt(aux[2]);
				  	}
				  }
				...
				for (var j = 0, l =shortURLList.length; j < l; j++) {
					...
					var ajaxopts = $.extend({
						  ...
						  success: function(data) {
							...
							provider = $.fn.oembed.getOEmbedProvider(data['long-url'], anchoForzado, altoForzado);
                ...
                provider = $.fn.oembed.getOEmbedProvider(resourceURL, anchoForzado, altoForzado);
    ...
    $.fn.oembed.getPhotoCode = function(url, oembedData) {
        ...
        code = '<div><a href="' + url + '" target=\'_blank\'><img src="' + oembedData.url + '" alt="' + alt + '" width="'+oembedData.width+'" height="'+oembedData.height+'" id="oembedElement" /></a></div>';
    ...
    $.fn.oembed.getOEmbedProvider = function(url, anchoForzado, altoForzado) {
        for (var i = 0; i < $.fn.oembed.providers.length; i++) {
            for (var j = 0, l =$.fn.oembed.providers[i].urlschemes.length; j < l; j++) {
                ...
                if (url.match(regExp) !== null) {
                	...
                	if(anchoForzado != null && altoForzado != null) {
                		provider.embedtag.width = anchoForzado;
                		provider.embedtag.height = altoForzado;
					}
